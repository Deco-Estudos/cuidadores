...
export function RecuperarSenhaPage() {
      ...
      <AuthLayout title="E-mail Enviado! ✉">
        <div style={{ textAlign: 'center', padding: '8px 0 16px' }}>
          ...
          <p style={{ fontSize: '15px', color: colors.secondary, lineHeight: 1.6, marginBottom: '24px' }}>
            Como esta versão não tem backend, simulamos a recuperação para <strong>{email}</strong>. Volte ao login e use a senha cadastrada localmente.
          </p>
  ...
  return (
    <AuthLayout
      ...
      subtitle="Digite seu e-mail para simular a recuperação de senha. Nenhum e-mail real será enviado."
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
        <Input label="E-mail" placeholder="Digite seu e-mail" type="email" value={email} onChange={e => setEmail(e.target.value)} />
        ...
        <p style={{ textAlign: 'center', fontSize: '12px', color: colors.muted }}>
          Dica demo: pedro@email.com / 123456
        </p>
